...
For an example on how to create and integrate the SonarQube instance on exisiting network resources by setting the parameter: `"var.create_networking_prereqs = false"`.  
