...
variable "vnet_address_space" {
  type        = list(string)
  default     = []
  description = "value of the address space for the virtual network. (Not required if existing network resources are used.)"
}
...
variable "resource_subnet_name" {
  type        = string
  default     = "tf-autotest-sonarqube-resource-sub"
...
variable "delegated_subnet_name" {
  type        = string
  default     = "tf-autotest-sonarqube-delegated-sub"
