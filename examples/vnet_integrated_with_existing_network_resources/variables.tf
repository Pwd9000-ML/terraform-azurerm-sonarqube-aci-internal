variable "network_resource_group_name" {
  type        = string
  default     = null
  description = "Name of the resource group where existing networking resources are hosted."
}
...
variable "virtual_network_name" {
  type        = string
  default     = null
  description = "Name of the virtual network where resources will be attached."
}

variable "private_dns_zones" {
  type        = list(string)
  default     = []
  description = "Private DNS zones for DNS VNET links."
}
